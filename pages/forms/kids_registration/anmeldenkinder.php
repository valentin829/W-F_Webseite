...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_kurs = "INSERT INTO `" . $schwimmkurs . "` (variante, kind_vorname, kind_nachname, eltern_vorname, eltern_nachname, email, telefonnummer, besonderheiten)
    VALUES ('$variante', '$kind_vorname', '$kind_nachname', '$eltern_vorname', '$eltern_nachname', '$email', '$telefonnummer' , '$besonderheit')";
...
<head>
    ...
    <link rel="stylesheet" href="../../../assets/css/anmeldenkinder.css">
